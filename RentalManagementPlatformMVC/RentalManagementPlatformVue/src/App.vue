                ...
                <div class="auto-container">
                    <div class="inner-container">
                        ...
                        <div class="right-column">
                            ...
                            <div class="menu-bar sidemenu-nav-toggler"><img src="./assets/images/icons/icon-bar3.png"
                                    alt=""></div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="inner-box">
                            <div class="wrapper-box">
                                <div class="image">
                                    ...
                                    <div class="overlay-link"><a href="./assets/images/gallery/instagram-1.jpg"
                                            class="lightbox-image" data-fancybox="gallery"><span
                                                class="fa fa-plus"></span></a></div>
                                </div>
                                <div class="image">
                                    <img src="./assets/images/news/news-ins-3.jpg" alt="">
                                    <div class="overlay-link"><a href="./assets/images/gallery/instagram-2.jpg"
                                            class="lightbox-image" data-fancybox="gallery"><span
                                                class="fa fa-plus"></span></a></div>
                                </div>
                                <div class="image">
                                    <img src="./assets/images/news/news-ins-4.jpg" alt="">
                                    <div class="overlay-link"><a href="./assets/images/gallery/instagram-3.jpg"
                                            class="lightbox-image" data-fancybox="gallery"><span
                                                class="fa fa-plus"></span></a></div>
                                </div>
                                <div class="image">
                                    <img src="./assets/images/news/news-ins-5.jpg" alt="">
                                    <div class="overlay-link"><a href="./assets/images/gallery/instagram-4.jpg"
                                            class="lightbox-image" data-fancybox="gallery"><span
                                                class="fa fa-plus"></span></a></div>
                                </div>
                                <div class="image">
                                    <img src="./assets/images/news/news-ins-6.jpg" alt="">
                                    <div class="overlay-link"><a href="./assets/images/gallery/instagram-5.jpg"
                                            class="lightbox-image" data-fancybox="gallery"><span
                                                class="fa fa-plus"></span></a></div>
                                </div>
                                <div class="image">
                                    <img src="./assets/images/news/news-ins-7.jpg" alt="">
                                    <div class="overlay-link"><a href="./assets/images/gallery/instagram-6.jpg"
                                            class="lightbox-image" data-fancybox="gallery"><span
                                                class="fa fa-plus"></span></a></div>
                                </div>
                                <div class="image">
                                    <img src="./assets/images/news/news-ins-8.jpg" alt="">
                                    <div class="overlay-link"><a href="./assets/images/gallery/instagram-7.jpg"
                                            class="lightbox-image" data-fancybox="gallery"><span
                                                class="fa fa-plus"></span></a></div>
                                </div>
                                <div class="image">
                                    <img src="./assets/images/news/news-ins-9.jpg" alt="">
                                    <div class="overlay-link"><a href="./assets/images/gallery/instagram-8.jpg"
                                            class="lightbox-image" data-fancybox="gallery"><span
                                                class="fa fa-plus"></span></a></div>
                                </div>
                                <div class="image">
                        ...
                        <div class="form-group">
                            <fieldset>
                                <input type="search" class="form-control" name="search-input" value=""
                                    placeholder="Type & Enter" required>
                            </fieldset>
                        </div>
                    </form>
                </div>
        ...
        <footer class="main-footer style-two" style="background-image: url(assets/images/background/bg-1.jpg);">
            ...
            <div class="footer-bottom">
                <div class="auto-container">
                    <div class="wrapper-box">
                        <div class="copyright">
                            <div class="text">Copyright Kingho. All right reserved.</div>
                        </div>
                        <div class="brand-logo">
                            <div class="theme_carousel owl-theme owl-carousel"
                                data-options='{"loop": true, "center": false, "margin": 30, "autoheight":true, "lazyload":true, "nav": true, "dots": true, "autoplay": true, "autoplayTimeout": 6000, "smartSpeed": 1000, "responsive":{ "0" :{ "items": "2" }, "480" :{ "items" : "3" }, "600" :{ "items" : "3" }, "768" :{ "items" : "4" } , "992":{ "items" : "4" }, "1200":{ "items" : "4" }}}'>
