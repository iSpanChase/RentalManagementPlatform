...
import type { RevenueKpiConfig } from '@/modules/ReportForm/api/reportForm';

const props = defineProps<{ modelValue: RevenueKpiConfig }>();
...
function updateField(key: keyof RevenueKpiConfig, value: any) {
