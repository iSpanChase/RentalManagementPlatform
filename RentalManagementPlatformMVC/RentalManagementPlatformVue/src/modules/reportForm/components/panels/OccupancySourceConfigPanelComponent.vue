...
import type { OccupancySourceConfig } from '@/modules/ReportForm/api/reportForm';

const props = defineProps<{ modelValue: OccupancySourceConfig }>();
...
function updateField(key: keyof OccupancySourceConfig, value: any) {
