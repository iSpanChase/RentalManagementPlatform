...
namespace ChaseCheng.Global.Utilities.Interface.CRUD
{
    ...
    public interface IQuery<Key, Values>: IQuerySingleCol<Key, Values>, IQueryWholeRow<Key, Values>
    {
        /// <summary>
        /// 用主鍵查詢一筆資料的單個欄位值
        /// </summary>
        ...
        /// </summary>
        /// <param name="Id">查詢物件的主鍵</param>
        /// <param name="values">回傳物件的單體資料結構</param>
        /// <returns>回傳是否成功</returns>
        bool TryQueryWholeRow(Key Id, out Values values);
    }
}
