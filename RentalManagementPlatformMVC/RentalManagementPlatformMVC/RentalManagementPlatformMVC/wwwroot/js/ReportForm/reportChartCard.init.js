  ...
  const ns = (window.ReportCard = window.ReportCard || { });
        ...
        <div class="card-body position-relative">
            <div class="d-flex justify-content-between align-items-start">
                ...
                <div class="btn-group btn-group-sm">
                    <button class="btn btn-light btn-edit" title="編輯">✎</button>
                    <button class="btn btn-light btn-delete" title="刪除">✖</button>
                </div>
            </div>
    ...
    async function requestAndRender() {
        const resp = await fetch(`${state.base}${state.endpoint}`, {method: "POST", body: (() => {
