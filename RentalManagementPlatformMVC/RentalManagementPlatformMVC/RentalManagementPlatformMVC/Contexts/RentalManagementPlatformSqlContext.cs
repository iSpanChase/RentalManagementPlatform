...
namespace RentalManagementPlatformMVC.Contexts;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AddressId).HasName("PK__ADDRESS__CAA247C835691DA6");
        ...
        {
            entity.HasKey(e => e.LogId).HasName("PK__ANOMALY___9E2397E0986D512D");
        ...
        {
            entity.HasKey(e => e.RuleId).HasName("PK__ANOMALY___E92A9296468710F1");
        ...
        {
            entity.HasKey(e => e.BookingId).HasName("PK__BOOKING__5DE3A5B11AC0F8E2");
        ...
        {
            entity.HasKey(e => e.BookingGuestId).HasName("PK__BOOKING___A6D88E885BD84DC1");
        ...
        {
            entity.HasKey(e => e.CategoriesId).HasName("PK__CATEGORI__92BEE78AF25338E8");

            entity.ToTable("CATEGORIES");

            entity.HasIndex(e => e.Name, "UQ__CATEGORI__72E12F1B8A62D5D2").IsUnique();
        ...
        {
            entity.HasKey(e => e.CityId).HasName("PK__CITY__031491A8C601AF9E");
        ...
        {
            entity.HasKey(e => e.CouponId).HasName("PK__COUPON__58CF638925627999");
        ...
        {
            entity.HasKey(e => e.CouponDistrictId).HasName("PK__COUPON_D__1F5D108EC1D40CBC");
        ...
        {
            entity.HasKey(e => e.CouponGuestId).HasName("PK__COUPON_G__538EB55DDA498F7F");
        ...
        {
            entity.HasKey(e => e.DistrictId).HasName("PK__DISTRICT__2521322BBF38D1D8");
        ...
        {
            entity.HasKey(e => e.FaqArticlesId).HasName("PK__FAQ_ARTI__B0FC36A67ECF6984");

            entity.ToTable("FAQ_ARTICLES");

            entity.HasIndex(e => e.Slug, "UQ__FAQ_ARTI__32DD1E4C4664DE28").IsUnique();
        ...
        {
            entity.HasKey(e => e.FaqCategoriesId).HasName("PK__FAQ_CATE__09E5F979893F406E");

            entity.ToTable("FAQ_CATEGORIES");

            entity.HasIndex(e => e.Slug, "UQ__FAQ_CATE__32DD1E4C7A6EB5A7").IsUnique();
        ...
        {
            entity.HasKey(e => e.FaqFeedbackId).HasName("PK__FAQ_FEED__4E34B38316924B4E");
        ...
        {
            entity.HasKey(e => e.PayoutId).HasName("PK__HOST_PAY__3B0771ECC2A2D2DB");
        ...
        {
            entity.HasKey(e => e.PayoutItemId).HasName("PK__HOST_PAY__7BD82C6E9D6818D4");
        ...
        {
            entity.HasKey(e => e.HostSubId).HasName("PK__HOST_SUB__70E025A8FBC36681");
        ...
        {
            entity.HasKey(e => e.MessageId).HasName("PK__MESSAGE__0BBF6EE68635DB1A");
        ...
        {
            entity.HasKey(e => e.MongodbId).HasName("PK__MONGODB__EC04A0A4ADAD4BE0");
        ...
        {
            entity.HasKey(e => e.TokenId).HasName("PK__PASSWORD__CB3C9E171E2859D9");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__PAYMENT__ED1FC9EA2E6BD1CB");
        ...
        {
            entity.HasKey(e => e.TransactionId).HasName("PK__PAYMENT___85C600AF4C7D61BD");
        ...
        {
            entity.HasKey(e => e.PermissionId).HasName("PK__PERMISSI__E5331AFAEA5DA3D8");

            entity.ToTable("PERMISSIONS");

            entity.HasIndex(e => e.PermCode, "UQ__PERMISSI__B74793E2D97D1070").IsUnique();
        ...
        {
            entity.HasKey(e => e.LedgerId).HasName("PK__POINT_LE__97EDEDA141E63A92");
        ...
        {
            entity.HasKey(e => e.RuleId).HasName("PK__POINT_RU__E92A9296D30AC267");
        ...
        {
            entity.HasKey(e => e.PostsId).HasName("PK__POSTS__7F3EFABED76CCDF6");
        ...
        {
            entity.HasKey(e => e.PostCategoriesId).HasName("PK__POSTS_CA__CA316AA51282FC69");
        ...
        {
            entity.HasKey(e => e.ReviewId).HasName("PK__REVIEW__60883D90D443A67A");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__ROLES__760965CC12106D10");

            entity.ToTable("ROLES");

            entity.HasIndex(e => e.RoleCode, "UQ__ROLES__BAE630754A19B5A4").IsUnique();
        ...
        {
            entity.HasKey(e => e.RolePermissionId).HasName("PK__ROLE_PER__B1E85A10C31BBFD0");
        ...
        {
            entity.HasKey(e => e.RoomId).HasName("PK__ROOM_LIS__19675A8A809EB4E9");
        ...
        {
            entity.HasKey(e => e.PhotoId).HasName("PK__ROOM_PHO__CB48C83DBB366697");
        ...
        {
            entity.HasKey(e => e.BillId).HasName("PK__SUBSCRIP__D706DDB31AA8ECD6");
        ...
        {
            entity.HasKey(e => e.PlanId).HasName("PK__SUBSCRIP__BE9F8F1D5E467A8E");
        ...
        {
            entity.HasKey(e => e.SupportTicketsId).HasName("PK__SUPPORT___494F3323CB3562FD");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__USER__B9BE370F7EBA6DE2");
        ...
        {
            entity.HasKey(e => e.FavoriteId).HasName("PK__USER_FAV__46ACF4CB1FDF8FDA");
        ...
        {
            entity.HasKey(e => e.UserRoleId).HasName("PK__USER_ROL__B8D9ABA2C9419A2E");
