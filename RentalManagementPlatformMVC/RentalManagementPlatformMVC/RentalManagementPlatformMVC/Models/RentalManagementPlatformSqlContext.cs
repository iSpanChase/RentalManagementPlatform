...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-PAKSETB\\SQLEXPRESS;Database=RentalManagementPlatformSQL;Trusted_Connection=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Address>(entity =>
        {
            entity.HasKey(e => e.AddressId).HasName("PK__ADDRESS__CAA247C8C4FF725B");
        ...
        {
            entity.HasKey(e => e.LogId).HasName("PK__ANOMALY___9E2397E0205B065B");
        ...
        {
            entity.HasKey(e => e.RuleId).HasName("PK__ANOMALY___E92A9296100DBE4E");
        ...
        {
            entity.HasKey(e => e.BookingId).HasName("PK__BOOKING__5DE3A5B1D8594A46");
        ...
        {
            entity.HasKey(e => e.BookingGuestId).HasName("PK__BOOKING___A6D88E88EFB07E1A");
        ...
        {
            entity.HasKey(e => e.CategoriesId).HasName("PK__CATEGORI__92BEE78AB278899C");

            entity.ToTable("CATEGORIES");

            entity.HasIndex(e => e.Name, "UQ__CATEGORI__72E12F1BCAD7A784").IsUnique();
        ...
        {
            entity.HasKey(e => e.CityId).HasName("PK__CITY__031491A84D472F5E");
        ...
        {
            entity.HasKey(e => e.CouponId).HasName("PK__COUPON__58CF638901EAA167");
        ...
        {
            entity.HasKey(e => e.CouponDistrictId).HasName("PK__COUPON_D__1F5D108E58422275");
        ...
        {
            entity.HasKey(e => e.CouponGuestId).HasName("PK__COUPON_G__538EB55DD9E5448B");
        ...
        {
            entity.HasKey(e => e.DistrictId).HasName("PK__DISTRICT__2521322B10E46551");
        ...
        {
            entity.HasKey(e => e.FaqArticlesId).HasName("PK__FAQ_ARTI__B0FC36A61893B7E1");

            entity.ToTable("FAQ_ARTICLES");

            entity.HasIndex(e => e.Slug, "UQ__FAQ_ARTI__32DD1E4C02709136").IsUnique();

            entity.Property(e => e.FaqArticlesId)
                .ValueGeneratedNever()
                .HasColumnName("faq_articles_id");
        ...
        {
            entity.HasKey(e => e.FaqCategoriesId).HasName("PK__FAQ_CATE__09E5F979B182321C");

            entity.ToTable("FAQ_CATEGORIES");

            entity.HasIndex(e => e.Slug, "UQ__FAQ_CATE__32DD1E4CC2558979").IsUnique();

            entity.Property(e => e.FaqCategoriesId)
                .ValueGeneratedNever()
                .HasColumnName("faq_categories_id");
            entity.Property(e => e.CreatedAt).HasColumnName("created_at");
            entity.Property(e => e.Description)
                .HasMaxLength(255)
                .HasColumnName("description");
        ...
        {
            entity.HasKey(e => e.FaqFeedbackId).HasName("PK__FAQ_FEED__4E34B38336AF75A7");

            entity.ToTable("FAQ_FEEDBACK");

            entity.Property(e => e.FaqFeedbackId)
                .ValueGeneratedNever()
                .HasColumnName("faq_feedback_id");
        ...
        {
            entity.HasKey(e => e.PayoutId).HasName("PK__HOST_PAY__3B0771EC588F1109");
        ...
        {
            entity.HasKey(e => e.PayoutItemId).HasName("PK__HOST_PAY__7BD82C6EB56D5F02");
        ...
        {
            entity.HasKey(e => e.HostSubId).HasName("PK__HOST_SUB__70E025A8D4F658E0");
        ...
        {
            entity.HasKey(e => e.MessageId).HasName("PK__MESSAGE__0BBF6EE6FF5F8081");
        ...
        {
            entity.HasKey(e => e.MongodbId).HasName("PK__MONGODB__EC04A0A470AAF43D");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__PAYMENT__ED1FC9EA45DF8735");
        ...
        {
            entity.HasKey(e => e.TransactionId).HasName("PK__PAYMENT___85C600AF94D858AF");
        ...
        {
            entity.HasKey(e => e.PermissionId).HasName("PK__PERMISSI__E5331AFAB9373156");

            entity.ToTable("PERMISSIONS");

            entity.HasIndex(e => e.PermCode, "UQ__PERMISSI__B74793E2FA62FDAD").IsUnique();
        ...
        {
            entity.HasKey(e => e.LedgerId).HasName("PK__POINT_LE__97EDEDA1318E9512");
        ...
        {
            entity.HasKey(e => e.RuleId).HasName("PK__POINT_RU__E92A929603186B4F");
        ...
        {
            entity.HasKey(e => e.PostsId).HasName("PK__POSTS__7F3EFABE68673581");
        ...
        {
            entity.HasKey(e => e.PostCategoriesId).HasName("PK__POSTS_CA__CA316AA5F80164CA");
        ...
        {
            entity.HasKey(e => e.ReviewId).HasName("PK__REVIEW__60883D907887A1AE");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__ROLES__760965CC39DFD687");

            entity.ToTable("ROLES");

            entity.HasIndex(e => e.RoleCode, "UQ__ROLES__BAE63075CB601ED0").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.RoleId, e.PermissionId }).HasName("PK__ROLE_PER__C85A5463C8245242");
        ...
        {
            entity.HasKey(e => e.RoomId).HasName("PK__ROOM_LIS__19675A8A141EA705");
        ...
        {
            entity.HasKey(e => e.PhotoId).HasName("PK__ROOM_PHO__CB48C83D19B9BF2A");
        ...
        {
            entity.HasKey(e => e.BillId).HasName("PK__SUBSCRIP__D706DDB3495995BA");
            ...
            entity.Property(e => e.Amount)
                .HasColumnType("decimal(18, 0)")
                .HasColumnName("amount");
            entity.Property(e => e.BillPeriodEnd).HasColumnName("bill_period_end");
            entity.Property(e => e.BillPeriodStart).HasColumnName("bill_period_start");
            entity.Property(e => e.CreatedAt).HasColumnName("created_at");
        ...
        {
            entity.HasKey(e => e.PlanId).HasName("PK__SUBSCRIP__BE9F8F1DB478D754");
        ...
        {
            entity.HasKey(e => e.SupportTicketsId).HasName("PK__SUPPORT___494F33239AE78A49");

            entity.ToTable("SUPPORT_TICKETS");

            entity.Property(e => e.SupportTicketsId)
                .ValueGeneratedNever()
                .HasColumnName("support_tickets_id");
            ...
            entity.HasOne(d => d.RelatedArticle).WithMany(p => p.SupportTickets)
                .HasForeignKey(d => d.RelatedArticleId)
                .HasConstraintName("FK_SUPPORT_TICKETS_related_article_id_FAQ_ARTICLES_faq_articles_id");
        });

        modelBuilder.Entity<User>(entity =>
        {
            entity.HasKey(e => e.UserId).HasName("PK__USER__B9BE370F89DD8D8E");

            entity.ToTable("USERS");

            entity.HasIndex(e => e.Phone, "UX_USER_Phone_NN")
                .IsUnique()
        ...
        {
            entity.HasKey(e => e.FavoriteId).HasName("PK__USER_FAV__46ACF4CBF78DCE1A");
        ...
        {
            entity.HasKey(e => e.UserRoleId).HasName("PK__USER_ROL__B8D9ABA2ED16E847");
