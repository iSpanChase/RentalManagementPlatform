...
📁 專案位置與結構
模組	位置	說明
前台（Vue 應用）	RentalManagementPlatformMVC/RentalManagementPlatformVue/package.json	採 Vue 3 + Vite 架構。
...
前台專用 Web API	RentalManagementPlatformMVC/RentalManagementPlatformMVC/RentalManagementPlatformWebAPI/RentalManagementPlatformWebAPI.csproj	純 RESTful API，供 Vue 前端呼叫。
